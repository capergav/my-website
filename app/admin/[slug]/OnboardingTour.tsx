...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: "Tap here to customise your restaurant's name, hero photo, colors, and font. Changes preview instantly.",
    target: "tour-theme",
  ...
  },
  {
    ...
    body: "Opens the live menu your customers see. Copy the link and share it via your website, Instagram bio, or a printed QR code.",
  ...
  },
  {
    ...
    body: "Tap this to add a dish. Upload a photo directly from your device, set the price, dietary flags, and availability.",
