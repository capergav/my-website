      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-[#2c2a26] rounded-3xl border-2 border-[#8b6914]/50 p-8 text-white">
          ...
          <ul className="space-y-2.5 text-sm text-white/80">
            {['Unlimited menu items','7 languages','QR code & shareable link','Dietary labels & filters','Custom categories','Real-time updates','Custom colors & fonts','Logo & hero image upload','Priority email support'].map(f => (
