          ...
          <div className="flex flex-col items-center sm:flex-row sm:justify-center sm:items-stretch gap-6 mt-14 py-8" style={{ perspective: 1200, overflow: "visible", paddingTop: 20, paddingBottom: 20 }}>
            ...
            <motion.div className="w-full sm:w-72 flex-shrink-0" style={{ width: "100%", maxWidth: 320, height: 420, display: "flex", flexDirection: "column", overflow: "visible" }} {...(rm ? {} : { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.5 } })}>
              ...
              >
                ...
                <div style={{ height: 110, flexShrink: 0, position: "relative", overflow: "hidden" }}>
                  ...
                  <div style={{ position: "absolute", bottom: 30, left: "50%", transform: "translateX(-50%)" }}>
                    <svg width="52" height="52" viewBox="0 0 72 72" fill="none"
                      ...
                      <path d="M30 24 Q33 20 36 20 Q39 20 42 24" fill="none" stroke="#5b9bd5" strokeWidth="2" strokeLinecap="round"/>
                      <line x1="24" y1="44" x2="48" y2="44" stroke="#5b9bd5" strokeWidth="2.5" strokeLinecap="round"/>
                      <path d="M20 48 Q28 54 36 54 Q44 54 52 48" fill="none" stroke="#5b9bd5" strokeWidth="2" strokeLinecap="round"/>
                    </svg>
                  </div>
                ...
                <div style={{ textAlign: "center", padding: "4px 0 8px", flexShrink: 0 }}>
                  <span style={{ fontSize: 9, color: "#1a2535", opacity: 0.3 }}>Powered by DineLinks</span>
                </div>
              </motion.div>
            </motion.div>
            ...
            <motion.div className="w-full sm:w-72 flex-shrink-0" style={{ width: "100%", maxWidth: 320, height: 420, display: "flex", flexDirection: "column", overflow: "visible" }} {...(rm ? {} : { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.5, delay: 0.1 } })}>
              ...
              >
                ...
                {/* Category note */}
                <p style={{ fontSize: 10, color: "#7c4a2a", fontStyle: "italic", padding: "5px 12px 2px", margin: 0, flexShrink: 0 }}>All yakitori served with pickled daikon.</p>
                {/* Dietary key */}
                <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "3px 12px 5px", fontSize: 10, color: "#7c4a2a", flexShrink: 0 }}>
                ...
                {/* Footer */}
                <div style={{ textAlign: "center", padding: "4px 0 8px", flexShrink: 0 }}>
                  <span style={{ fontSize: 9, color: "#1c1109", opacity: 0.3 }}>Powered by DineLinks</span>
                </div>
              </motion.div>
            </motion.div>
            ...
            <motion.div className="w-full sm:w-72 flex-shrink-0" style={{ width: "100%", maxWidth: 320, height: 420, display: "flex", flexDirection: "column", overflow: "visible" }} {...(rm ? {} : { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.5, delay: 0.2 } })}>
              ...
              >
                ...
                {/* Footer */}
                <div style={{ textAlign: "center", padding: "6px 0 12px", color: "#b8a89c", fontSize: 9, opacity: 0.5, flexShrink: 0 }}>
                  ⊡ Powered by DineLinks
                </div>
              </motion.div>
            </motion.div>
      ...
      <footer className="bg-[#2c2a26] pt-12 pb-10">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-10">
          ...
          <div className="flex flex-col sm:flex-row items-start justify-between gap-6 py-8 border-b border-[#faf8f5]/10">
            ...
            <div className="flex items-center gap-3">
              {[
                { label: "Instagram", href: "https://www.instagram.com/dinelinks/", icon: (
          ...
          <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
            <p className="text-xs text-[#faf8f5]/30">© 2026 DineLinks. All rights reserved.</p>
